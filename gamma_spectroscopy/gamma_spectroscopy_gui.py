...
from gamma_spectroscopy.picoscope_5000a import INPUT_RANGES, PicoScope5000A
...
class UserInterface(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        export_spectrum_time = QtWidgets.QAction("&Export events", self)
        export_spectrum_time.setShortcut("Ctrl+D")
        export_spectrum_time.triggered.connect(self.export_spectrum_times)
        ...
        file_menu.addAction(export_spectrum_time)
    ...
    def set_trigger(self):
        ...
        if self.trigger_channel_box.currentText() == "A AND B":
            ...
            self.scope.set_trigger_A_AND_B(
                self._polarity_sign * self._threshold,
                edge,
                is_enabled=self._is_trigger_enabled,
            )
        ...
        if (
            self.trigger_channel_box.currentText() != "A OR B"
            and self.trigger_channel_box.currentText() != "A AND B"
        ):
    ...
    def export_spectrum_times(self):
        """Dialog for exporting a data file."""
